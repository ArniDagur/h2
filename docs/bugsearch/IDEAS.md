...
## Tried
- F1–F63 fixes; #853 dismiss; I1/I2 conservation; S3 dismiss.
...
- `try_assign_capacity` u32 sub when available > window_size (SETTINGS reclaim should prevent; defensive saturating_sub).
